...
public class Assignment2_Register_TN {
	
	//VerifyingRegisterWithMandatoryFields
	//VerifyingRegisterWithAllFields
	//VerifyingRegisterWithExistingEmail
	//VerifyingRegistetWithNoFields
